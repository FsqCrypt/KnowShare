package com.fsq.auth.service;

import lombok.RequiredArgsConstructor;
import com.fsq.auth.api.dto.AuthResponse;
import com.fsq.auth.api.dto.AuthUserResponse;
import com.fsq.auth.api.dto.LoginRequest;
import com.fsq.auth.api.dto.PasswordResetRequest;
import com.fsq.auth.api.dto.RegisterRequest;
import com.fsq.auth.api.dto.SendCodeRequest;
import com.fsq.auth.api.dto.SendCodeResponse;
import com.fsq.auth.api.dto.TokenRefreshRequest;
import com.fsq.auth.api.dto.TokenResponse;
import com.fsq.auth.audit.LoginLogService;
import com.fsq.auth.config.AuthProperties;
import com.fsq.common.exception.BusinessException;
import com.fsq.common.exception.ErrorCode;
import com.fsq.auth.model.ClientInfo;
import com.fsq.auth.model.IdentifierType;
import com.fsq.auth.token.JwtService;
import com.fsq.auth.token.RefreshTokenStore;
import com.fsq.auth.token.TokenPair;
import com.fsq.user.domain.User;
import com.fsq.user.service.UserService;
import com.fsq.auth.util.IdentifierValidator;
import com.fsq.auth.verification.SendCodeResult;
import com.fsq.auth.verification.VerificationCheckResult;
import com.fsq.auth.verification.VerificationCodeStatus;
import com.fsq.auth.verification.VerificationScene;
import com.fsq.auth.verification.VerificationService;
